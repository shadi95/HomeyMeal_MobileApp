 ...
 @override
  ...
  void _loadData() async {
    if(widget.categoryModel.name == null) {
      await Provider.of<CategoryProvider>(context, listen: false).getCategoryList(context, true);
    ...
    Provider.of<CategoryProvider>(context, listen: false).getSubCategoryList(context, _categoryModel.id.toString());
  }
                        ...
                        child: Container(
                          ...
                          child: TabBar(
                            ...
                            onTap: (int index) {
                              _tabIndex = index;
                              if(index == 0) {
                                category.getCategoryProductList(context, _categoryModel.id.toString());
                              }else {
